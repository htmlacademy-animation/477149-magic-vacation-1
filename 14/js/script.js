...
/* harmony import */ var _utils__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./utils */ "./source/js/2d-scenes/animation/utils.js");
...
class Animation {
  constructor(options) {
    ...
    if (!this.options.easing) {
      this.options.easing = _utils__WEBPACK_IMPORTED_MODULE_0__["default"].easeLinear;
    }
...
/***/ "./source/js/2d-scenes/animation/scene-2d.js":
/*!***************************************************!*\
  !*** ./source/js/2d-scenes/animation/scene-2d.js ***!
  \***************************************************/
/*! exports provided: default */
...
/***/ "./source/js/2d-scenes/animation/utils.js":
/*!************************************************!*\
  !*** ./source/js/2d-scenes/animation/utils.js ***!
  \************************************************/
/*! exports provided: easeInOutSinus, default */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "easeInOutSinus", function() { return easeInOutSinus; });
...
/***/ "./source/js/2d-scenes/loseScene/scene-crocodile.js":
/*!**********************************************************!*\
  !*** ./source/js/2d-scenes/loseScene/scene-crocodile.js ***!
  \**********************************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return SceneCrocodile; });
/* harmony import */ var _animation_animation__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../animation/animation */ "./source/js/2d-scenes/animation/animation.js");
/* harmony import */ var _animation_scene_2d__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../animation/scene-2d */ "./source/js/2d-scenes/animation/scene-2d.js");
/* harmony import */ var _animation_utils_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../animation/utils.js */ "./source/js/2d-scenes/animation/utils.js");
...
class SceneCrocodile extends _animation_scene_2d__WEBPACK_IMPORTED_MODULE_1__["default"] {
  constructor() {
  ...
  initAnimations() {
    this.animations.push(
      new _animation_animation__WEBPACK_IMPORTED_MODULE_0__["default"]({
        func: () => this.drawScene(),
        duration: "infinite",
        fps: 60,
      })
  ...
  initKeyAnimations() {
    this.animations.push(
      new _animation_animation__WEBPACK_IMPORTED_MODULE_0__["default"]({
        ...
        duration: 187,
        delay: 0,
        easing: _animation_utils_js__WEBPACK_IMPORTED_MODULE_2__["default"].easeInOutSinus,
      })
    );
  }
  ...
  initFlamingoAnimations() {
    this.animations.push(
      new _animation_animation__WEBPACK_IMPORTED_MODULE_0__["default"]({
        ...
        duration: 617,
        delay: 100,
        easing: _animation_utils_js__WEBPACK_IMPORTED_MODULE_2__["default"].easeOutCubic,
      }),
      new _animation_animation__WEBPACK_IMPORTED_MODULE_0__["default"]({
        func: (progress) => {
        ...
        duration: 583,
        delay: 717,
        easing: _animation_utils_js__WEBPACK_IMPORTED_MODULE_2__["default"].easeInCubic,
      })
    );
  }
  ...
  initCrocodileAnimation() {
    this.animations.push(new _animation_animation__WEBPACK_IMPORTED_MODULE_0__["default"]({
        func: (progress) => {
...
/***/ "./source/js/2d-scenes/main.js":
/*!*************************************!*\
  !*** ./source/js/2d-scenes/main.js ***!
  \*************************************/
/*! exports provided: runWinScene, runLoseScene */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "runWinScene", function() { return runWinScene; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "runLoseScene", function() { return runLoseScene; });
/* harmony import */ var _winScene_scene_sea_calf__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./winScene/scene-sea-calf */ "./source/js/2d-scenes/winScene/scene-sea-calf.js");
/* harmony import */ var _loseScene_scene_crocodile__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./loseScene/scene-crocodile */ "./source/js/2d-scenes/loseScene/scene-crocodile.js");



const runWinScene = () => new _winScene_scene_sea_calf__WEBPACK_IMPORTED_MODULE_0__["default"]();
const runLoseScene = () => new _loseScene_scene_crocodile__WEBPACK_IMPORTED_MODULE_1__["default"]();


/***/ }),

/***/ "./source/js/2d-scenes/winScene/scene-sea-calf.js":
/*!********************************************************!*\
  !*** ./source/js/2d-scenes/winScene/scene-sea-calf.js ***!
  \********************************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return SceneSeaCalf; });
/* harmony import */ var _animation_animation_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../animation/animation.js */ "./source/js/2d-scenes/animation/animation.js");
/* harmony import */ var _animation_scene_2d_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../animation/scene-2d.js */ "./source/js/2d-scenes/animation/scene-2d.js");
/* harmony import */ var _animation_utils_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../animation/utils.js */ "./source/js/2d-scenes/animation/utils.js");
...
class SceneSeaCalf extends _animation_scene_2d_js__WEBPACK_IMPORTED_MODULE_1__["default"] {
  constructor() {
  ...
  initAnimations() {
    this.animations.push(new _animation_animation_js__WEBPACK_IMPORTED_MODULE_0__["default"]({
      func: () => this.drawScene(),
      duration: `infinite`,
      fps: 60
    }));
  ...
  initBlobAnimations() {
    this.animations.push(new _animation_animation_js__WEBPACK_IMPORTED_MODULE_0__["default"]({
      ...
      duration: 500,
      delay: 1200,
      easing: _animation_utils_js__WEBPACK_IMPORTED_MODULE_2__["default"].easeInQuad
    }));
  }
  ...
  initSeaCalfAnimations() {
    this.animations.push(new _animation_animation_js__WEBPACK_IMPORTED_MODULE_0__["default"]({
      ...
      duration: 2000,
      delay: 1000,
      easing: _animation_utils_js__WEBPACK_IMPORTED_MODULE_2__["default"].easeOutElastic
    }));
...
/***/ "./source/js/modules/first-load.js":
/*!*****************************************!*\
  !*** ./source/js/modules/first-load.js ***!
  \*****************************************/
/*! exports provided: default */
...
/* harmony import */ var _prizes_animation__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./prizes-animation */ "./source/js/modules/prizes-animation.js");
...
class FullPageScroll {
  ...
  changeVisibilityDisplay() {
    ...
    if (this.screenElements[this.activeScreen].id === `prizes`) {
      _prizes_animation__WEBPACK_IMPORTED_MODULE_1__["prizesAnimation"].init();
    } else {
      _prizes_animation__WEBPACK_IMPORTED_MODULE_1__["prizesAnimation"].destroy();
    }
  }
...
class Game {
  ...
  start() {
    ...
    this.timer = new _game_timer__WEBPACK_IMPORTED_MODULE_0__["default"](this.timerRef);
    this.timer.init();
  }
...
/***/ "./source/js/modules/numbers-animation.js":
/*!************************************************!*\
  !*** ./source/js/modules/numbers-animation.js ***!
  \************************************************/
/*! exports provided: NumbersAnimation */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "NumbersAnimation", function() { return NumbersAnimation; });
...
/*!***********************************************!*\
  !*** ./source/js/modules/prizes-animation.js ***!
  \***********************************************/
/*! exports provided: prizesAnimation */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "prizesAnimation", function() { return prizesAnimation; });
/* harmony import */ var _numbers_animation__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./numbers-animation */ "./source/js/modules/numbers-animation.js");
...
class PrizesAnimation {
  ...
  init() {
    ...
    setTimeout(() => {
      ...
      setTimeout(() => {
        new _numbers_animation__WEBPACK_IMPORTED_MODULE_0__["NumbersAnimation"](this.secondNum, 1, 7);
      }, 1500);
    }, 1500);
    ...
    setTimeout(() => {
      ...
      setTimeout(() => {
        new _numbers_animation__WEBPACK_IMPORTED_MODULE_0__["NumbersAnimation"](this.thirdNum, 11, 900);
      }, 1500);
    }, 2000);
  }
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _2d_scenes_main__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../2d-scenes/main */ "./source/js/2d-scenes/main.js");
/* harmony import */ var _game__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./game */ "./source/js/modules/game.js");
  ...
  if (results.length) {
    for (let i = 0; i < showResultEls.length; i++) {
      showResultEls[i].addEventListener(`click`, function () {
        _game__WEBPACK_IMPORTED_MODULE_1__["game"].end();

        let target = showResultEls[i].getAttribute(`data-target`);

        if (target === "result") {
          Object(_2d_scenes_main__WEBPACK_IMPORTED_MODULE_0__["runWinScene"])();
        } else if (target === 'result3') {
          Object(_2d_scenes_main__WEBPACK_IMPORTED_MODULE_0__["runLoseScene"])();
        }
  ...
  const setSlider = function () {
    if (((window.innerWidth / window.innerHeight) < 1) || window.innerWidth < 769) {
      storySlider = new swiper__WEBPACK_IMPORTED_MODULE_0__["default"](`.js-slider`, {
        ...
        on: {
          init: () => {
            bodyElement.classList.remove(`blue`, `light-blue`, `purple`);
            bodyElement.classList.add(`light-purple`);
          },
          slideChange: () => {
            if (storySlider.activeIndex === 0 || storySlider.activeIndex === 1) {
              sliderContainer.style.backgroundImage = `url("img/slide1.jpg"), linear-gradient(180deg, rgba(83, 65, 118, 0) 0%, #523E75 16.85%)`;
              bodyElement.classList.remove(`blue`, `light-blue`, `light-purple`);
              ...
              bodyElement.classList.remove(`purple`, `light-blue`, `light-purple`);
              ...
              bodyElement.classList.remove(`purple`, `blue`, `light-purple`);
              bodyElement.classList.add(`light-blue`);
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _modules_first_load_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./modules/first-load.js */ "./source/js/modules/first-load.js");
...
// init modules
Object(_modules_first_load_js__WEBPACK_IMPORTED_MODULE_0__["default"])();
...
const animateIntroTitle = new _modules_text_animation__WEBPACK_IMPORTED_MODULE_10__["default"]({
  element: `.intro__title`,
  multiline: true,
  delay: 100
});

const animateDate = new _modules_text_animation__WEBPACK_IMPORTED_MODULE_10__["default"]({
  element: `.intro__date`,
  delay: 1000
});

const animateSliderTitle = new _modules_text_animation__WEBPACK_IMPORTED_MODULE_10__["default"]({
  element: `.slider__item-title`,
  delay: 100
});

const animatePrizesTitle = new _modules_text_animation__WEBPACK_IMPORTED_MODULE_10__["default"]({
